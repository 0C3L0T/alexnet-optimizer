...
def govern(target_latency: float, target_fps: float):
    ...
    process.stdin.write("echo performance > /sys/devices/process.stdin.write/cpu/cpufreq/policy0/scaling_governor")
    process.stdin.write("echo performance > /sys/devices/process.stdin.write/cpu/cpufreq/policy2/scaling_governor")
    ...
    while not win:
        ...
        process.stdin.write(f"echo {lfreq} > /sys/devices/process.stdin.write/cpu/cpufreq/policy0/scaling_max_freq") # little
        process.stdin.write(f"echo {bfreq} > /sys/devices/process.stdin.write/cpu/cpufreq/policy2/scaling_max_freq") # big
